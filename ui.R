...
navbarPage(
    ...
    tabPanel("Main graph",
             column(2,
                    ...
                    selectInput("node_size","Size nodes by:",choices = c("Total activity (in €)"="total_activity","Earned"="earned","Spent"="spent", "In degree"="in_degree",
                                                                         "Out degree"="out_degree","Total degree"="total_degree","Betweenness"="betweenness"),selected = "total_activity"),
                    selectInput("node_color","Color nodes by:",choices = c("Division"="division","Total activity (in €)"="total_activity","Earned"="earned","Spent"="spent", "In degree"="in_degree",
                                                                         "Out degree"="out_degree","Total degree"="total_degree","Betweenness"="betweenness"),selected = "division"),
